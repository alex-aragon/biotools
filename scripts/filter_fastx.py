...
parser.add_argument("-p", "--path", 
					help="by default the file is saved to the path of the FASTX file. This flag saves it to the current location",
					action="store_true")
...
pathOut=os.path.split(inputFASTX)[0] # Get path of FASTX file
